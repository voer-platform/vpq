...
<?php echo $this->Form->create('ScoresAnswer'); ?>
	<fieldset>
		<legend><?php echo __('Edit Scores Answer'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ScoresAnswer.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ScoresAnswer.id'))); ?></li>

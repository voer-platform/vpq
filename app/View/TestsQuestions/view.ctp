...
<h2><?php echo __('Tests Question'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($testsQuestion['TestsQuestion']['id']); ?>
			&nbsp;
		</dd>
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Tests Question'), array('action' => 'delete', $testsQuestion['TestsQuestion']['id']), array(), __('Are you sure you want to delete # %s?', $testsQuestion['TestsQuestion']['id'])); ?> </li>

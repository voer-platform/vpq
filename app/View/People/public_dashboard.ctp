								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12">
												...
												<span class="badge badge-info overviews-ranking hasDetail" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-content="Vị trí của bạn trong bảng xếp hạng môn <?=$subj['Subject']['name'];?><br/><b><font color='red'>Bạn cần đăng nhập để sử dụng</font></b>">
									...
									<div class="row <?php echo ($noTest)?'blur3':''; ?>">
										...
										<div class="col-md-4 col-sm-4 col-xs-3 pdr-5">
											<a href="javascript:void(0);" class="nudl no-style hasDetail" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-content="Điểm trung bình môn <?=$subj['Subject']['name'];?><br/><b><font color='red'>Bạn cần đăng nhập để sử dụng</font></b>">
										...
										<div class="col-md-8 col-sm-8 col-xs-9 fs-12 pdl-5">
											<?php echo __('Tiến trình học tập'); ?> <a href="javascript:void(0);" class="hasDetail pull-right pls-popover" data-type="Progress Popover" data-trigger="hover" data-container="body" data-toggle="popover" data-placement="top" data-html="true" data-content="Được tính bằng tỷ lệ số bài học đã thực hành trên tổng số bài của môn học này<br/><b><font color='red'>Bạn cần đăng nhập để sử dụng</font></b>"><span class="glyphicon glyphicon-question-sign"></span></a>

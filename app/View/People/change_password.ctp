<form method="POST">
	...
	<div class="form-group">
		<label class="control-label"><?php echo __('Comfirm new password'); ?></label>
		<input type="password" id="renew-password" id="" placeholder="<?php echo __('Retype new password'); ?>" class="form-control" />
	</div>	
</form>
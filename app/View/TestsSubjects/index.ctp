<div class="testsSubjects index">
	<h2><?php echo __('Tests Subjects'); ?></h2>
	...
	<tbody>
	<?php foreach ($testsSubjects as $testsSubject): ?>
	<tr>
		<td><?php echo h($testsSubject['TestsSubject']['id']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $testsSubject['TestsSubject']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $testsSubject['TestsSubject']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $testsSubject['TestsSubject']['id']), array(), __('Are you sure you want to delete # %s?', $testsSubject['TestsSubject']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>

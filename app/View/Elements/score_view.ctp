...
<div class="visible-xs">
	<h3 class="center mgt-0"><?php echo __('Test'); ?>: <?php echo $subject['Subject']['name']; ?></h3>
...
<div id="modalicon" class="modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-sm w-md-700">
        <div class="modal-content">
			<div class="modal-body" style='text-align:center'>				
					...
					<table style='border:0px;width:100%;'>
						<tr>
							...
							<td style='text-align:left;width:350px;'>
								...
								<span style='color:red;font-size:30px;' class="hidden-xs">Chúc mừng bạn!<span><br/>
								<?php endif;?>
								<?php if(round($correct/$numberOfQuestions,2)*10<8 && round($correct/$numberOfQuestions,2)*10>4): ?>
								<span style='color:red;font-size:30px;' class="hidden-xs">Cố gắng lên bạn nhé!<span><br/>
								<?php endif;?>
								<?php if(round($correct/$numberOfQuestions,2)*10<5): ?>
								<span style='color:red;font-size:30px;' class="hidden-xs">Cố gắng hết mình nào!<span><br/>
								<?php endif;?>					
							</td>
							<td style='width:110px;'>
								<?php if(round($correct/$numberOfQuestions,2)*10>=8): ?>
				...
				<br/>
				<div class="more-result-score hidden-xs">
			...
			<div class="modal-footer">		
				...
				<div class="visible-xs">
					<button class="btn show-answers btn-primary" id="btn-show-answers" data-dismiss="modal"><?php echo __('Show Answers'); ?></button>
				   <button class="btn show-solutions btn-primary" id="btn-show-solutions" data-dismiss="modal"><?php echo __('Show Solutions'); ?></button>
				   <?php echo $this->Html->link('Quay lại', array('controller' => 'people', 'action' => 'dashboard',$subject['Subject']['id']), array('class' => 'btn btn-dashboard btn-primary')) ?>
				   <br/><br/>
				   <button class="btn btn-block btn-primary fb-share-button" id="fb-share-modal" data-position="popup"><span class="glyphicon glyphicon-share-alt"></span> &nbsp;<?=__('Share');?></button>
				</div>
			</div>
        </div>
    </div>
...
<div id="msgNotice" class="modal" tabindex="-1" role="dialog" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-sm" style="width:30%;">
        <div class="modal-content">
            ...
            <div class="modal-body" style='text-align:center'>
                <p id='tb'>Cảm ơn sự đóng góp của bạn!</p>
            </div>
            <div class="modal-footer">
